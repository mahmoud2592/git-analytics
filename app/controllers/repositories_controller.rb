class RepositoriesController < ApplicationController
  ...
  private
    ...
    def repository_params
      params.require(:repository).permit(:name, :description, :programming_language, :license, :url, :default_branch, :stars_count, :forks_count, :watchers_count, :issues_count, :pull_requests_count, :commit_count)
    end
end
